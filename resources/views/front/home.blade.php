            ...
            <div class="card text-black" style="width: 90%; font-size: 0.8rem; margin: auto;">
                ...
                <div class="card-body" style="padding: 10px;">
                    ...
                    <a href="{{ route('product.details', ['id' => $product->id]) }}">
                        ...
                        <button class="btn btn-primary" style="width: 48%; background-color:#fd7e14; border-color:#fd7e14;" data-bs-toggle="modal" data-bs-target="#requestModal">Request Now</button>

                        <form action="{{ route('cart.store') }}" method="POST" style="display: inline-block; width: 48%;">
                            @csrf
            ...
            <div class="modal-body">
                ...
                <div class="mb-4">
                    ...
                    <div class="d-flex justify-content-around">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="privateLocation" name="locationDescription[]" value="Private">
                            <label class="form-check-label" for="privateLocation">Private</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="schoolRented" name="locationDescription[]" value="School Rented">
                            <label class="form-check-label" for="schoolRented">School</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="rentLocation" name="locationDescription[]" value="Rent">
                            <label class="form-check-label" for="rentLocation">Rent</label>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        <select class="form-control" id="secondProduct" name="secondProduct" required>
                            <option value="" disabled selected>Choose</option>
                            <option value="Material1">Waffle</option>
                            <option value="Material2">Mini PanCake</option>
                            <option value="Material3">Japanese PanCake</option>
                            <option value="Material4">Waffle Stick</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="row mb-4">
                    <div class="col-md-6">
                        ...
                        <select class="form-control" id="rawMaterials1" name="rawMaterials" required>
                            <option value="" disabled selected>Choose</option>
                            <option value="Material1">No Additional</option>
                            <option value="Material2">50 Extra people (172.5 SAR)</option>
                            <option value="Material3">100 Extra people (345 SAR)</option>
                            <option value="Material4">200 Extra people (690 SAR)</option>
                            <option value="Material5">400 Extra people (1380 SAR)</option>
                            <option value="Material6">800 Extra people (2760 SAR)</option>
                        </select>
                    </div>
                ...
                <div class="mb-4">
                    ...
                    <select class="form-control" id="rawMaterials" name="rawMaterials" required>
                        <option value="" disabled selected>Choose</option>
                        <option value="Material1">Belgian Chocolate Free</option>
                        <option value="Material2">Caramel Sauce Free</option>
                        <option value="Material3">Pistachio Sauce Free</option>
                    </select>
                </div>

                <div class="text-end fw-bold mb-4">
                    Total Price: <span id="totalPriceText">0.0 SAR</span>
                </div>
            </div>
