...
@endif
    ...
    <section style="margin-top: 50px; padding: 20px 0; background-color:#f5ece0">
    <div class="container">
        <!-- Title Section -->
...
<div style="text-align: center; margin-bottom: 20px; background-color:#f5ece0;">
  <h1 style="font-size: 24px; font-weight: bold; color: #333;">Instagram Posts</h1>
</div>

<div style="display: flex; justify-content: center; gap: 20px; flex-wrap: wrap; max-width: 100%; background-color:#f5ece0;">
  <!-- المنشور الأول -->
